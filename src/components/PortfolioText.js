  ...
  <div className="contain">
    ...
    <Card className="mobileContain">
      ...
      <CardBody>
        ...
        <CardText className="bodyCopy">
          A PWA that takes in user data and stashes it locally till a connection
          to a secure database is made. For use in a financial setting.
        </CardText>
        <a href="https://github.com/rlgerma92/budgetTracker">
          <Button>View</Button>
        </a>
    ...
    <Card className="mobileContain">
      ...
      <CardBody>
        ...
        <CardText className="bodyCopy">
          A web app for people that want to track their workouts and progress
          over time! Graphs display real time data.
        </CardText>
        <a href="https://trackthatworkout.herokuapp.com/">
          <Button>View</Button>
        </a>
    ...
    <Card className="mobileContain">
      ...
      <CardBody>
        <CardTitle className="title">Note Taker</CardTitle>
        <CardSubtitle className="subTitle">Express.Js/Bootstrap</CardSubtitle>
        <CardText className="bodyCopy">
    ...
    <Card className="mobileContain">
      ...
      <CardBody>
        ...
        <CardSubtitle className="subTitle">A blog post</CardSubtitle>
        <CardText className="bodyCopy">
          An article I wrote about deconstructing the various files in modern
          MVC frameworks
        </CardText>
        <a href="https://spark.adobe.com/page/Pkquz58VaeU0F/">
          <Button>View</Button>
